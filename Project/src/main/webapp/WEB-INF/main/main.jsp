								...
								<div class="">
									...
									<div class="card_login-body">
										...
										<form action="${cpath}/login.do">
											<div class="">
												<input class="form-control" name="mb_id" style="border-radius: 10px;height: 20px;top:80%" id="inputId" type="text" placeholder="아이디를 입력하세요."  required/>
												
											</div>
											<div class="form-floating mb-3" style="margin-bottom: 50px;">
												<input class="form-control" name="mb_pw" style="border-radius: 10px;height: 20px;" id="inputPassword" type="password" placeholder="비밀번호를 입력하세요."  required/>
											</div>
