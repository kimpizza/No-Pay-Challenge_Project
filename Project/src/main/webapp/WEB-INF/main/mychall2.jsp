...
<body>
 ...
 <nav>
    ...
    <script src="assets/demo/jquery-3.6.0.min.js"></script>
    ...
    var myLineChart = new Chart(ctx, {
      type: 'bar',
      data: {
        labels: ["August 1", "August 2", "August 3", "August 4", "August 5", "August 6", "August 7", "August 8", "August 9", "August 10", "August 11", "August 12", "August 13","August 14", "August 15", "August 16", "August 17", "August 18", "August 19", "August 20", "August 21"], 
        datasets: [{
          label: "Sessions",
          lineTension: 0.3,
          ...
          pointHitRadius: 50,
          pointBorderWidth: 2,
          data: [${sumPay[0]}, ${sumPay[1]}, ${sumPay[2]}, ${sumPay[3]}, ${sumPay[4]}, ${sumPay[5]}, ${sumPay[6]}, ${sumPay[7]}, ${sumPay[8]},${sumPay[9]},${sumPay[10]},${sumPay[11]},${sumPay[12]}, ${sumPay[13]}, ${sumPay[14]}, ${sumPay[15]}, ${sumPay[16]}, ${sumPay[17]}, ${sumPay[18]}, ${sumPay[19]}, ${sumPay[20]}, ${sumPay[21]}],
        }],
      },
      options: {
        scales: {
